    ...
    <div id="text">
      <div id="code">
        <font color="#FF0000">
          ...
          <span class="say"> 情不知所起一往而深</span><br>
          <span class="say"> </span><br>
          <span class="say"> 不知何时开始慢慢的喜欢你了</span><br>
          <span class="say"> </span><br>
          <span class="say"> 不是寂寞，没有冲动，而是真心</span><br>
          <span class="say"> </span><br>
          <span class="say"> 我知道我不会甜言蜜语，希望你能给我用行动证明的机会</span><br>
          <span class="say"> </span><br>
          <span class="say"> 不管你有多任性，我都会疼你、哄你、包容你</span><br>
          <span class="say"> </span><br>
          <span class="say"> 我喜欢你忽闪的大眼睛，喜欢看你卖萌，喜欢看你傻笑</span><br>
          <span class="say"> </span><br>
          <span class="say"> 我想走进你的世界</span><br>
          <span class="say"> </span><br>
