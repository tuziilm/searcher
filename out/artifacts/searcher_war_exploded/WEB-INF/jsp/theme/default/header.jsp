<%@page import="com.tuziilm.searcher.common.SystemUserType"%>
<%@page import="com.tuziilm.searcher.common.LoginContext"%>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <a class="brand" href="${basePath}">管理后台</a>
          <div class="nav-collapse collapse">
            <p class="navbar-text pull-right">
              ${searcher:username()}，您好！ <a href="${basePath}logout" class="navbar-link">退出</a>
            </p>
            <ul class="nav">
