...
public class SecurityInterceptor extends HandlerInterceptorAdapter {
	...
	private final static Set<String> openApis= Sets.newHashSet("/login", "/tutu", "/index/appconfig","/index/softlogin","/index/softlogout","/index/findpasswd","/index/register","/index/isLogin","/index/editpwd","/index/userDefined","/user/register_gzip","/user/register","/get/get_ad_3","/get/get_ad");
