...
import com.tuziilm.searcher.statistics.common.AbstractLogFileHandler;
import com.tuziilm.searcher.statistics.common.ChartPvUvData;
import com.tuziilm.searcher.statistics.common.Config;
import com.tuziilm.searcher.common.LogModule;
import com.tuziilm.searcher.statistics.common.ValidLineEntry;
...
public class LinkNodePvUvAnalyzer implements Analyzer {
    public final static Set<String> NAME_SET= Sets.newHashSet(LogModule.USER_LOGIN.name());
    private Date date;
    ...
    public static class LineEntry extends com.tuziilm.searcher.statistics.common.LineEntry {
